...
BOT_TOKEN = environ.get("BOT_TOKEN", "6372243428:AAHNDVGoCg8gSHl_1VBVZx-cuB05GsIABKY")
...
NOR_IMG = environ.get('NOR_IMG', "https://imgur.com/a/I7Mvinv.jpg")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '2034319320 6541599863').split()]
...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '6541599863').split()]
...
SUPPORT_CHAT_ID = int(environ.get('SUPPORT_CHAT_ID', '-1001725315551'))
# Command
...
S_GROUP = environ.get('S_GROUP',"https://t.me/+V-PDw57m4dY5NDU1")
GRP_LNK = environ.get('GRP_LNK',"https://t.me/+V-PDw57m4dY5NDU1")
MAIN_CHANNEL = environ.get('MAIN_CHANNEL',"https://t.me/+DIFevVBulGYzYzk1")
FILE_FORWARD = environ.get('FILE_FORWARD',"https://t.me/+DIFevVBulGYzYzk1")
MSG_ALRT = environ.get('MSG_ALRT', ' Hey How Are U 💞')
FILE_CHANNEL = int(environ.get('FILE_CHANNEL', 0))
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001924870738'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+DIFevVBulGYzYzk1')
